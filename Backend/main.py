...
# Add SSL mode if not present and using Supabase
...
# Database setup with connection pooling settings
...
app = FastAPI(title="SocialMap API", version="1.0.0", lifespan=lifespan)
